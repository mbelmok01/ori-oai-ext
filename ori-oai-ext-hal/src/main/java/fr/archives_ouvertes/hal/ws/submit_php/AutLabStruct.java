...
public class AutLabStruct  implements java.io.Serializable {
    private fr.archives_ouvertes.hal.ws.submit_php.AuthorStruct[] authors;

    private fr.archives_ouvertes.hal.ws.submit_php.LaboratoryStruct[] labs;

    public AutLabStruct() {
    }

    public AutLabStruct(
           fr.archives_ouvertes.hal.ws.submit_php.AuthorStruct[] authors,
           fr.archives_ouvertes.hal.ws.submit_php.LaboratoryStruct[] labs) {
     ...
     * @return authors
     */
    public fr.archives_ouvertes.hal.ws.submit_php.AuthorStruct[] getAuthors() {
        return authors;
    }
     ...
     * @param authors
     */
    public void setAuthors(fr.archives_ouvertes.hal.ws.submit_php.AuthorStruct[] authors) {
        this.authors = authors;
    }
     ...
     * @return labs
     */
    public fr.archives_ouvertes.hal.ws.submit_php.LaboratoryStruct[] getLabs() {
        return labs;
    }
     ...
     * @param labs
     */
    public void setLabs(fr.archives_ouvertes.hal.ws.submit_php.LaboratoryStruct[] labs) {
        this.labs = labs;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://paol.ccsd.cnrs.fr/ws/submit.php", "AutLabStruct"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("authors");
        elemField.setXmlName(new javax.xml.namespace.QName("", "authors"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://paol.ccsd.cnrs.fr/ws/submit.php", "AuthorStruct"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("labs");
        elemField.setXmlName(new javax.xml.namespace.QName("", "labs"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://paol.ccsd.cnrs.fr/ws/submit.php", "LaboratoryStruct"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
